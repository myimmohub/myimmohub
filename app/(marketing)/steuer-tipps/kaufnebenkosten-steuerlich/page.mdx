...
export const metadata = {
  ...
  description:
    "Grunderwerbsteuer, Notar, Makler und Gutachter — welche Kaufnebenkosten steuerlich abzugsfähig sind und wie sie korrekt behandelt werden.",
};
...
export default function Page({ children }) {
  return (
    <ArticleLayout
      title="Kaufnebenkosten: Was Vermieter von der Steuer absetzen können"
      description="Grunderwerbsteuer, Notar, Makler und Gutachter — welche Kaufnebenkosten steuerlich abzugsfähig sind und wie sie korrekt behandelt werden."
      date="2024-08-05"
      readingTime="5 Min. Lesezeit"
      tags={["Kaufnebenkosten", "Grunderwerbsteuer", "AfA", "Anschaffungskosten"]}
    >
      {children}
    </ArticleLayout>
  );
