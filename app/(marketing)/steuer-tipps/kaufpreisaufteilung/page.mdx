...
export const metadata = {
  ...
  description:
    "Wie du den Kaufpreis zwischen Gebäude und Grundstück aufteilst, beeinflusst direkt deine jährliche AfA. Mit dem richtigen Verhältnis sparst du tausende Euro Steuern.",
};
...
export default function Page({ children }) {
  return (
    <ArticleLayout
      title="Kaufpreisaufteilung: Gebäude vs. Grundstück steuerlich optimieren"
      description="Wie du den Kaufpreis zwischen Gebäude und Grundstück aufteilst, beeinflusst direkt deine jährliche AfA. Mit dem richtigen Verhältnis sparst du tausende Euro Steuern."
      date="2024-10-20"
