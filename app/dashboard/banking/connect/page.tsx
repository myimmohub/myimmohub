      ...
      <section className="mx-auto w-full max-w-2xl">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <Link
            ...
            className="group flex flex-col rounded-xl border border-zinc-200 bg-white p-5 shadow-sm transition hover:border-zinc-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700"
          >
            {/* Icon */}
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-100 text-zinc-600 transition group-hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-400 dark:group-hover:bg-zinc-700">
          ...
          <div className="flex flex-col rounded-xl border border-zinc-200 bg-zinc-50 p-5 opacity-60 dark:border-zinc-800 dark:bg-zinc-900/50">
            {/* Icon */}
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-200 text-zinc-400 dark:bg-zinc-800 dark:text-zinc-600">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5">
            ...
            {/* Placeholder CTA */}
            <div className="mt-4 text-sm font-medium text-zinc-400 dark:text-zinc-600">
              Bald verfügbar
            </div>
          </div>
